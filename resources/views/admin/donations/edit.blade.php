...
<div class="col-sm-12">
    <div class="card user-list">
        <div class="card-header">
            <h5><a href="{{ url('admin/donation/list') }}">Donation</a> >> Edit Donation</h5>
        </div>
	    <div class="card-body">
	        <div class="m-t-10 p-0">
	            <form id="form" method="POST" action="{{url('admin/donation/update')}}">
	                {{ csrf_field() }}
	                ...
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="mobile" class="form-control" value="{{$donation->mobile}}">
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="amount" class="form-control" value="{{$donation->amount}}">
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="method" class="form-control" value="{{$donation->method}}">
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="donation_date" class="form-control" value="{{$donation->donation_date}}">
	                            </div>
	                        </div>
	                    </div>
	                </div>
