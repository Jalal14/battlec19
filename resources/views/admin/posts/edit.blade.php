    ...
    <div class="card user-list">
	    ...
	    <div class="card-body">
	        <div class="m-t-10 p-0">
	            <form id="form" method="POST" action="{{url('admin/post/update')}}" enctype="multipart/form-data">
	                {{ csrf_field() }}
	                ...
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="area" class="form-control" value="{{$post->area}}">
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="in_charge" class="form-control" value="{{$post->in_charge}}">
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-9">
	                                <input type="text" name="donation_date" class="form-control" value="{{$post->donation_date}}">
	                            </div>
	                        </div>
	                    </div>
	                </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                  <div class="custom-file">
                                      <input type="file" name="cover" class="custom-file-input" id="validatedCustomFile">
                              ...
                              <div class="col-md-9">
                                <img src="{{asset('public/uploads/posts')}}/{{$post->donationImages->where('is_cover', 1)->first()->photo}}" class="img-thumbnail">
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <label for="cover" class="col-md-2 col-form-label">Uploaded photos</label>
                      <div class="col-md-9">
                        <div class="row">
                            @forelse($post->donationImages->where('is_cover', 0) as $image)
                                <div class="col-md-4">
                                    <img src="{{asset('public/uploads/posts')}}/{{$image->photo}}" class="img-thumbnail">
                                    <i class="fa fa-times attachment-item-delete" data-id="{{$image->id}}" data-attachment="public/uploads/posts" title="Delete Attachment" aria-hidden="true"></i>
                                </div>
                            @empty
                            @endforelse
                          </div>
